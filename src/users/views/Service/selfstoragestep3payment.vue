      ...
      <div class="row">
        <div class="col-md-12">
          <div class="sectoin-title">
            <h2>
              {{ $store.state.resource.selfstoragestep3payment.paymentheading }}
            </h2>
          </div>
        </div>
      </div>
        ...
        <div class="col-md-12" style="display: flex">
          <div class="col-md-8">
            <div class="form-group">
              ...
              >
                <strong>{{
                  $store.state.resource.selfstoragestep3payment.billinginfo
                }}</strong>
              </div>
              <div
                class="col-md-12"
              ...
              >
                <div class="col-md-6" style="padding-left: 0px !important">
                  <input
                    ...
                    class="form-control"
                    :placeholder="
                      $store.state.resource.selfstoragestep3payment
                        .firstnameplaceholder
                    "
                    maxlength="25"
                    autocomplete="off"
                    id="firstName"
                    v-model="vmodel.selfstoragestep3.firstname"
                    :class="{
                      'is-invalid': $v.vmodel.selfstoragestep3.firstname.$error,
                    }"
                  />
                  <span
                    v-if="
                      $v.vmodel.selfstoragestep3.firstname.required === false
                    "
                ...
                >
                  <input
                    ...
                    autocomplete="off"
                    id="lastName"
                    v-model="vmodel.selfstoragestep3.lastname"
                    :class="{
                      'is-invalid': $v.vmodel.selfstoragestep3.lastname.$error,
                    }"
                  />
                  <span
                    v-if="
                      $v.vmodel.selfstoragestep3.lastname.required === false
                    "
                    class="invalid-feedback"
                  >
              ...
              <div class="col-md-12" style="padding-left: 0px !important">
                <div class="form-group">
                  <input
                    ...
                    id="phoneno"
                    v-model="vmodel.selfstoragestep3.phonenumber"
                    :class="{
                      'is-invalid':
                        $v.vmodel.selfstoragestep3.phonenumber.$error,
                    }"
                  />
                  <span
                    v-if="
                      $v.vmodel.selfstoragestep3.phonenumber.required === false
                    "
                    class="invalid-feedback"
                  >
            ...
            <div class="form-group">
              <div
                class="sectoin-title"
                style="font-size: 24px; font-weight: 400 !important"
              >
                <strong>{{
                  $store.state.resource.selfstoragestep3payment.carddetail
                }}</strong>
              </div>
              <div class="col-md-12" style="padding-left: 0px !important">
              ...
              <CCard>
                <CCardHeader>
                  <CCol style="font-size: 20px; color: #000000">
                    <strong>{{
                      $store.state.resource.selfstoragestep3payment.order
                    }}</strong>
                  </CCol>
                  <CCol>
                    <CButton
                      ...
                      >{{
                        $store.state.resource.selfstoragestep3payment.orderedit
                      }}</CButton
                    >
                  </CCol>
                </CCardHeader>
                    ...
                    >
                      ...
                      {{
                        $store.state.language == "chinese"
                          ? vmodel.selfstoragestep2.storedetail.branch.label.split(
                              "/"
                            )[1]
                          : vmodel.selfstoragestep2.storedetail.branch.label.split(
                              "/"
                      ...
                      -
                      {{ vmodel.selfstoragestep2.sqfeet }}
                      {{
                        $store.state.resource.selfstoragestep3payment.btnsqft
                      }}
                      - {{ vmodel.selfstoragestep2.duration }}
                      {{
                        $store.state.resource.selfstoragestep3payment.btnmonths
                      }}
                    </CCol>
                    <CCol
                      class="col-4"
            ...
            <div style="padding-top: 30px">
              <CCard>
                <CCardHeader>
                  <CCol style="font-size: 20px; color: #000000">
                    <strong>{{
                      $store.state.resource.selfstoragestep3payment.appoinment
                    }}</strong>
                  </CCol>
                  <CCol>
                    <CButton
                ...
                <CCardBody>
                  <CRow>
                    <CCol class="col-4" style="font-size: 20px; color: #000000">
                      {{
                        $store.state.resource.selfstoragestep3payment
                          .appoinmentdate
                      }}
                    </CCol>
                    <CCol class="col-8" style="font-size: 20px; color: #007bff">
                      {{ vmodel.selfstoragestep2.appointment.date }} :
                      {{ vmodel.selfstoragestep2.appointment.starttime }} -
                      {{ vmodel.selfstoragestep2.appointment.endtime }}
                    </CCol>
                  </CRow>
                  <CRow>
                    <CCol class="col-4" style="font-size: 20px; color: #000000">
        ...
        <div class="row justify-content-end">
          <div class="col-1 buttons2">
            <a
              ...
              v-on:click="paymentdone()"
            >
              {{ $store.state.resource.selfstoragestep3payment.btnconfirm }}</a
            >
          </div>
        </div>
      </form>
  ...
  methods: {
        ...
        .then(function (result) {
          if (result.error) {
            ...
            var data = {
              ...
              amount: self.vmodel.selfstoragestep2.charges * 100,
              currency: "hkd",
    ...
    orderComplete(clientSecret) {
      ...
      this.stripe.retrievePaymentIntent(clientSecret).then(function (result) {
        self.vmodel.selfstoragestep3.paymentid = result.paymentIntent.id;
